...
var DominionOfficeView = function() {
	...
	var CalculatorImage, FolderImage, FolderLettersImage, GlobeImage,
		 LaptopImage, NewspapersImage, PDAImage, PhoneImage;		//UNLOGGED
	var Cabinet, Calendar, Chart, Clock;											//wall accessories
	var Calculator, Folders, Globe, Laptop, Newspapers, PDA, Phone;		//desk accessories
	//-budget pie chart, word games?, pic of leader?
	var DeskTrapezoid;
...
DominionOfficeView.prototype.SetComponents = function() {  //UNLOGGED
	...
	this.Calendar.Set(this.Specs.CALENDAR, this.GraphicsTool);
	...
	this.Phone = new OfficePaperStash();
