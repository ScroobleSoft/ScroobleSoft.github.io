...
//---------------------------------------------------------
//----------- LEXI TURTLE STASH VIEW ----------------------
var LexiTurtleStashView = function() {
...
LexiTurtleStashView.prototype = new GenieView();
LexiTurtleStashView.prototype.Set = function(cnvs, specs) {
...
LexiTurtleStashView.prototype.SetControls = function() {
...
LexiTurtleStashView.prototype.SetImages = function() {
...
LexiTurtleStashView.prototype.Open = function() {
	GenieView.prototype.Open.call(this);

	this.Update();
};
LexiTurtleStashView.prototype.Update = function() {
	...
	if (Mouse.CheckLeftClicked(CANVAS.PRIME)) {
		...
		if (this.Col<this.Specs.NUMBERS.C && this.Col>=0 && this.Row<this.Specs.NUMBERS.R && this.Row>=0) {		//check within numbers frame
			...
			if ((this.indx+(100*this.StashIcons.DepressedIcon))<TurtleView.Selector.Solutions.length) {		//check if valid cell is clicked
	...
	if (this.OkButton.CheckClicked()) {
		...
		TurtleView.Selector.SelectStash((100*this.StashIcons.DepressedIcon)+this.CellIndex);
		TurtleView.Shell.SetSolution(TurtleView.Selector);
		this.Close(this.OpenTurtleView.bind(this), 100);
	}
};
LexiTurtleStashView.prototype.Draw = function() {

	this.TextWriter.Write("Pick a number:", 5, 30, { FONT: "24px Arial" } );
	this.DrawNumbers();
};
LexiTurtleStashView.prototype.PickGameNumber = function() {
...
LexiTurtleStashView.prototype.DrawNumbers = function() {
	var x, y;
	var iCell;
	var c, r;
	...
	for (r=0;r<this.Specs.NUMBERS.R;++r)
		for (c=0;c<this.Specs.NUMBERS.C;++c) {
			if ((iCell+(100*this.StashIcons.DepressedIcon))>=TurtleView.Selector.Solutions.length)
				return;
...
LexiTurtleStashView.prototype.DrawDigits = function(num, x, y) {
	var i;
	var nDgts;
	var dgt;
...
LexiTurtleStashView.prototype.OpenTurtleView = function() {
