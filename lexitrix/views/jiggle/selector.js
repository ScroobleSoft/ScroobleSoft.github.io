...
//-----------------------------------------------------
//---------- JIGGLE WORDS SELECTOR --------------------
var JiggleWordsSelector = function() {
	var Randomizer;
	var JiggleWords, SelectedWords;
	var Distribution;
	var WordList, FourthWordList, FifthWordList, SixthWordList;
};
JiggleWordsSelector.prototype = {
	Set(rGenerator) {
	...
	SetData() {
		...
		//Words
		this.JiggleWords = [ Words5a, Words5b, Words5c, Words5d, Words5e, Words5f, Words5g, Words5h, Words5i, Words5j, Words5k, Words5l, Words5m,
									Words5n, Words5o, Words5p, Words5q, Words5r, Words5s, Words5t, Words5u, Words5v, Words5w ];
		this.Distribution = new Array(this.JiggleWords.length);
		for (i=0;i<this.JiggleWords.length;++i)
			this.Distribution[i] = this.JiggleWords[i].length;
	...
	Select() {  //TODO: duplicates still an issue
	 ...
	 this.GetParedList(this.JiggleWords[iLttr], this.SelectedWords[1][4], this.FourthWordList);
	 if (this.FourthWordList.length!=0) {
		 ...
		 this.GetParedList(this.JiggleWords[iLttr], this.SelectedWords[2][2], this.FifthWordList);
		 if (this.FifthWordList.length!=0) {
			 ...
			 this.GetParedList(this.JiggleWords[iLttr], this.SelectedWords[1][2], this.SixthWordList);
	...
	GetThreeWords() {  //top, left and right
		...
		this.GetParedList(this.JiggleWords[iSlot], null, this.WordList);
		...
		this.GetParedList(this.JiggleWords[iLttr], null, this.WordList);
