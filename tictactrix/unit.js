...
TacticalUnit.prototype.Draw = function() {

	this.DetermineScreenCoords();
	if (this.Direction==DIRECTION.E)
		this.Sprite = this.EastSprite.Draw(this.ScreenCoords.X, this.ScreenCoords.Y, this.Clan.Index);
	else
		this.Sprite = this.WestSprite.Draw(this.ScreenCoords.X, this.ScreenCoords.Y, this.Clan.Index);
};
