...
TacticalTrooper.prototype.Set = function(specs, sprite) {
	TacticalUnit.prototype.Set.call(this, specs, sprite);

	this.Type = TACTICAlUNIT.TROOPER;
};
TacticalTrooper.prototype.Draw = function(specs, sprite) {  //UNLOGGED - TODO: adjust for animation
	...
	if (this.Direction==DIRECTION.E) {
		...
		FeetSprite.Draw(this.ScreenCoords.X+this.Specs.FEET.E.X, this.ScreenCoords.Y+this.Specs.FEET.E.Y);
	} else {
		LeftArmSprite.Draw(this.ScreenCoords.X+this.Specs.ARM.W.X, this.ScreenCoords.Y+this.Specs.ARM.W.Y);
		FeetSprite.Draw(this.ScreenCoords.X+this.Specs.FEET.W.X, this.ScreenCoords.Y+this.Specs.FEET.W.Y);
	}
};
