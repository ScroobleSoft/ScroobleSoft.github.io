...
var PAGINATION = { PATCH: { W: 18, H: 18, },
						 COLOUR: { STRIP: "rgb(175,191,191)", SELECTION: GREY.MEDIUM, PAGE: "rgb(000,175,239)", BACKGROUND: "rgb(000,000,255)" } };
var TOUChBAR = { COLOUR: { KEY: "rgb(175,191,191)", SELECTION: "rgb(063,191,223)", DISABLED: GREY.MEDIUM } };			 
var TABS = { COLOUR: { TAB: "lightgray", PAGE: "white" } };
var SPInCONTROlBUTTOnIMAGEs = { L: 102, T: 72, W: 54, H: 10, O: 2, C: 4, R: 1, PATCH: { W: 12, H: 10 } };
var BArCHART = { COLOUR: { BACKGROUND: GREY.LIGHT } };
