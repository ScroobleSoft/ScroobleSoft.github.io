/*
 *  file will be REDUNDANT after transition to library sprites complete
 */
//----------------------------------------------
//----------ANIMATED SPRITE---------------------
...
AnimatedSprite.prototype.Set = function(cntxt, imgs, specs) {
   GenieSprite.prototype.Set.call(this, cntxt, imgs, specs);
...
AnimatedSprite.prototype.CreateImageGallery = function(tInfo) {  //UNTESTED
   ...
   GenieSprite.prototype.CreateImageGallery.call(this);
...
GeometricSprite.prototype.Set = function(cntxt, specs, gTool, iBox) {
   ...
   if (!this.Composite)
      GenieSprite.prototype.Set.call(this, cntxt, null, specs, iBox);  //ISSUE: shouldn't do this like that
};
GeometricSprite.prototype.SwitchContext = function() {
   GenieSprite.prototype.SwitchContext.call(this);

   this.GraphicsTool.SwitchContext(this.SecondaryContext);
};
GeometricSprite.prototype.RestoreContext = function() {
   GenieSprite.prototype.RestoreContext.call(this);
...
GeometricSprite.prototype.CreateImageGallery = function(info, columns) {
   ...
   GenieSprite.prototype.CreateImageGallery.call(this, info);
...
//   this.TransformedSpecs = JSON.parse(JSON.stringify(this.TempSpecs)); - NOTE: remove when all fixed
   ...
   if (this.Composite)
      GenieSprite.prototype.DrawResized.call(this, x, y+this.Height);
};
/*
...
GeometricSprite.prototype.Draw = function(x, y, opcty) {
   ...
   for (i=0;i<specs.length;++i) {
	 ...
	 case SHAPE.POLYGON :
	    ...
	    this.GraphicsTool.DrawRegularPolygon(x+l, y+t, size, sides, specs[i][SHAPeSPEC.COLOUR], specs[i][SHAPeSPEC.WIREFRAME], specs[i][SHAPeSPEC.STYLE], angle, opcty);
	    break;
	 case SHAPE.HEXAGON :
	    size = specs[i][SHAPeSPEC.DIMENSIONS][2];
...
CompositeSprite.prototype.Set = function(cntxt, iSrc, specs, gTool, iBox) {
   ...
   GenieSprite.prototype.Set.call(this, cntxt, iSrc, specs, iBox);
};
...
CompoundSprite.prototype = new GenieSprite();
CompoundSprite.prototype.Set = function(cntxt, src, specs, attachedSpritesSpecs) {
   var i;
   var sprite;
   var attachedSpriteInfo;

   GenieSprite.prototype.Set.call(this, cntxt, src, specs, attachedSpritesSpecs);
...
//};
//ChameleonSprite.prototype = new GenieSprite();
