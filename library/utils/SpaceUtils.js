...
SpatialUtilities.prototype = {
	...
	CheckPointInArea(pnt, tLeft, w, h) {  //t- top
	...
	CheckPointInRect(pnt, l, t, w, h) {

		if ( pnt.X<l || pnt.Y<t || pnt.X>(l+w) || pnt.Y>(t+h) )
	 return (false);
...
/*  based on the following formula:
		if (RectA.Left < RectB.Right && RectA.Right > RectB.Left && RectA.Top > RectB.Bottom && RectA.Bottom < RectB.Top )
			return (true);  NOTE: Y-coord comparisons are reversed for Cartesian
*/
...
//		return (this.CheckPointInBox(cPos, rct, rds));  //TODO: revised approach, to be TESTED
	}
};
