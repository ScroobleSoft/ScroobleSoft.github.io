...
var StarterDistributions = [  //NOTE: used in roster generation
	[ [1,2,2,1,5], [1,2,2,1,5], [1,2,2,1,5], [1,2,2,1,5], [1,2,3,1,5], [1,2,2,1,5], [1,1,2,2,5],     		//NONE/IFORM/IFORMP/IFORMR/HYBRD/MIX/2TE
	  [1,2,2,1,5], [1,1,3,1,5], [1,1,4,1,5], [1,2,2,1,5], [1,2,2,2,5], [1,3,2,2,5], [1,2,3,1,5]  ],  		//SPLTBK/3WR/4WR/OFFST/H-BCK/2H-BCK/WNGT
	[ [2,2,3,2,2], [2,2,3,2,2], [2,2,3,2,2], [2,2,3,2,2], [2,2,4,2,2], [2,2,3,2,2], [1,3,4,2,2],				//MM43/COVER2/TAMPA2/COVER3/ZONE43/MM34/MM44
	  [2,2,3,2,2], [2,1,4,2,3], [2,2,3,2,3], [2,2,3,2,2], [2,2,3,2,2], [2,1,4,2,2], [2,1,4,2,3]  ]			//ZN34C2/ZN34C3/ZONE34/TWoNT/FIVeDL/MM46
];
...
var ROSTER = { SLOTS: { MINIMUM: { QB: 2, RB: 3, WR: 4, TE: 2, OL: 7, DE: 3, DT: 3, LB: 6, S: 3, CB: 3, COUNT: 36 }, RANDOM: 10 },
					...
					STARTERS: { QB1: 0, RB1: 1, RB2: 2, WR1: 3, WR2: 4, TE: 5, OL1: 6, OL2: 7, OL3: 8, OL4: 9, OL5: 10,		  			//TODO: relevant only
									DE1: 11, DE2: 12, DT1: 13, DT2: 14, LB1: 15, LB2: 16, LB3: 17, S1: 18, S2: 19, CB1: 20, CB2: 21  }		// to IfORM/43 - REDUNDANT?
};
var Starters = [ "QB1", "RB1", "RB2", "WR1", "WR2", "TE", "OL1", "OL2", "OL3", "OL4", "OL5",
					  "DE1", "DE2", "DT1", "DT2", "LB1", "LB2", "LB3", "S1", "S2", "CB1", "CB2" ];		//TODO: relevant only to IfORM/43 . . . REDUNDANT?
